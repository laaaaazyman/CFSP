...
from src.model.base import CFNBaseModel
from src.schema.base import SentenceResult
from src.schema.frame import FeResult, FeWithScore
from src.data.RoleIdentification_dict import Rolemap
