...
from src.data.WordSpliting_dicts import POSmap
from src.schema.base import SentenceResult, TargetParsing, Word, Sentence, Target
from src.schema.frame import POS
from src.utils import cfn_cache
