...
from CFSP.data.WordSpliting_dicts import POSmap
from CFSP.schema.base import SentenceResult, TargetParsing, Word, Sentence, Target
from CFSP.schema.frame import POS
from CFSP.utils import cfn_cache
